...
WORKDIR /go/src/github.com/dillonlpeterson/shippy-consignment-cli
...
COPY --from=builder /go/src/github.com/dillonlpeterson/shippy-consignment-cli/consignment-cli .
