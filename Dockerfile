...
WORKDIR /go/src/bitbucket.org/dillonlpeterson/shippy-consignment-cli
...
COPY --from=builder /go/src/bitbucket.org/dillonlpeterson/shippy-consignment-cli/consignment-cli .
COPY --from=builder /go/src/bitbucket.org/dillonlpeterson/shippy-consignment-cli/consignment.json .
